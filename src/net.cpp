...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "KarpelesCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"karpelescoin.org", "dnsseed.karpelescoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"karpelescoincoin.org", "test-dnsseed.karpelescoincoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. KarpelesCoin is probably already running."), addrBind.ToString().c_str());
        else
